...
ActiveRecord::Schema.define(version: 20150917133908) do
  ...
  add_index "subscriptions", ["subclonnit_id"], name: "index_subscriptions_on_subclonnit_id", using: :btree
  ...
  add_foreign_key "subscriptions", "subclonnits"
